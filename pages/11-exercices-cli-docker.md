...
## PostgreSQL Stack + Web Interface

### 🎯 **Objective** : Your first database with an interface
...
- Equivalent of phpMyAdmin but for PostgreSQL
...
--name my-postgres          # Container name (to refer to it)
...
- Logs without "database system is ready" error
...
**🌐 Network magic** : phpPgAdmin can reach `my-postgres` by its name!
...
**💡 Understand** : Your data is **physically** stored on your disk, not in the container!
...
### 🎯 **Objective** : Professional website with database
...
```bash
# During installation, monitor the logs
...
### 🎯 **Objective** : Simulate a DevOps production environment
...
tail -f /dev/null                  # Keeps container active
```
...
echo "⏳ Starting monitoring stack (30 seconds)..."
sleep 30
...
```bash
# While you configure, monitor the metrics
...
# 🎉 Complete Exercises Summary

<small>

### 🟢 **Simple Level - Database**
